      ...
      <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-12 lg:gap-20">
        <div className="flex-1 space-y-8 max-w-2xl">
          <div className="space-y-6">
            ...
            <p className="text-xl sm:text-xl text-white/60 leading-relaxed max-w-xl font-light">
          ...
          <div className="flex flex-wrap gap-5 pt-4">
            <button className="group relative bg-[#21e786] text-black px-10 py-5 font-semibold transition-all hover:opacity-90 overflow-hidden">
            ...
            <button className="bg-black text-white px-10 py-5 font-semibold border border-white/20 hover:border-[#21e786] transition-all">
              Learn More
            </button>
          </div>
